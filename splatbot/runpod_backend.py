...
def render_remote_worker_command(settings: Settings, job: ScanJob, pod_id: str) -> str:
    ...
    pipeline_exports = "\n".join(
        ...
        for name, value in {
            ...
            "SPLATBOT_MIN_COLMAP_SPARSE_POINTS": settings.min_colmap_sparse_points,
            ...
            "SPLATBOT_OBJECT_MASK_STRATEGY": settings.object_mask_strategy,
            ...
            "SPLATBOT_OBJECT_MASK_CLOSE_PX": settings.object_mask_close_px,
            "SPLATBOT_OBJECT_MASK_ERODE_PX": settings.object_mask_erode_px,
            "SPLATBOT_OBJECT_MASK_AGREEMENT_MIN_IOU": settings.object_mask_agreement_min_iou,
            ...
            "SPLATBOT_DA3_MODEL_CACHE_DIR": settings.da3_model_cache_dir,
            "SPLATBOT_DA3_ALLOW_MODEL_DOWNLOAD": str(settings.da3_allow_model_download).lower(),
            "SPLATBOT_DA3_MODEL_DOWNLOAD_ATTEMPTS": settings.da3_model_download_attempts,
            ...
            "SPLATBOT_VGGT_DEMO_COLMAP": settings.vggt_demo_colmap,
            "SPLATBOT_VGGT_RUN_COMMAND": settings.vggt_run_command,
            ...
            "SPLATBOT_MAST3R_PAIR_CYCLIC": str(settings.mast3r_pair_cyclic).lower(),
            "SPLATBOT_MAST3R_DEVICE": settings.mast3r_device,
