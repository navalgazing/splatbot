...
class Settings(BaseSettings):
    ...
    best_segmentation_backends: str = "conservative,rembg"
    best_segmentation_required_backends: str = "conservative"
    ...
    object_mask_training_alpha_threshold: int = 64
    object_mask_close_px: int = 1
    object_mask_erode_px: int = 2
    object_mask_agreement_min_iou: float = 0.45
    object_mask_clear_background_rgb: bool = True
    object_mask_background_rgb: str = "255,255,255"
    ...
    object_clear_colmap_sparse_points: bool = True
    ...
    silhouette_cleanup_alpha_threshold: int = 64
    silhouette_cleanup_padding_px: int = 0
    silhouette_cleanup_outside_ratio: float = 0.35
    silhouette_cleanup_max_inside_views: int = 4
    silhouette_cleanup_max_inside_ratio: float = 0.25
    ...
    mask_support_cleanup_min_inside_views: int = 3
    mask_support_cleanup_min_inside_ratio: float = 0.06
    mask_support_cleanup_max_remove_fraction: float = 0.6
    depth_consistency_cleanup_enabled: bool = True
    depth_consistency_cleanup_min_views: int = 2
    depth_consistency_cleanup_max_depth_ratio: float = 1.4
    depth_consistency_cleanup_min_inconsistent_ratio: float = 0.67
    depth_consistency_cleanup_alignment_sample_limit: int = 20_000
    depth_consistency_cleanup_min_scale_samples: int = 20
    depth_consistency_cleanup_max_remove_fraction: float = 0.5
    postprocess_validation_enabled: bool = True
    postprocess_validation_max_outside_fraction: float = 0.2
    postprocess_validation_min_inside_views: int = 3
    postprocess_validation_min_inside_ratio: float = 0.06
    postprocess_validation_max_low_support_fraction: float = 0.05
