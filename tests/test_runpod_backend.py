...
def test_remote_worker_command_exports_pipeline_settings(tmp_path) -> None:
    ...
    assert "export SPLATBOT_BEST_POSE_BACKENDS=vggt-colmap,mast3r-sfm,colmap-global,colmap-sequential,colmap-exhaustive,colmap" in command
    ...
    assert "export SPLATBOT_VGGT_MAX_IMAGES=96" in command
